/*! OpinionPromoGenerator - v0.1.0 - 2013-03-15
* Copyright (c) 2013 */
...
Template = (function() {
  ...
  Template.prototype.setUrl = function(url) {
    return this.url = url + "?hp&rref=opinion";
  };
  ...
  Template.prototype.htmlStory = function() {
    ...
    html += this.thumbHtml("177", 'width="177"');
    if (this.kicker.test()) {
      html += "<h6 class=\"kicker\">" + this.kicker.value + "</h6>";
    }
    if (this.headline.test()) {
      html += "<h5><a href=\"" + this.url + "\" >" + this.headline.value + "<i class='icon dot-logo-icon hidden'></i></a></h5>";
    }
  ...
  Template.prototype.htmlHeadlineOnly = function() {
    var html;
    return html = "<li class=\"headlineOnly\"><a href=\"" + this.url + "\">" + this.headline.value + "<i class='icon dot-logo-icon hidden'></i></a></li>";
  };
...
ElementSundayReview = (function(_super) {
  ...
  ElementSundayReview.prototype.html = function(position) {
    if (position === this.top || position === this.bottom) {
      return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/?ref=global-home" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/sundayReviewHpC375.png" /></a></h4>';
    } else if (position === this.left || position === this.right) {
      if (this.isCentered) {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/international/?ref=global-home#sundayreview" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/sundayReviewHpC177.png" border="0" /></a></h4>';
      } else {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/international/?ref=global-home#sundayreview" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/sundayReviewHpL177.png" border="0" /></a></h4>';
      }
    } else {
      return "";
    }
...
ElementTheOpinionPages = (function(_super) {
  ...
  ElementTheOpinionPages.prototype.html = function(position) {
    if (position === this.top || position === this.bottom) {
      return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/international/?ref=global-home" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/opinionPagesHpC375.png" /></a></h4>';
    } else if (position === this.left || position === this.right) {
      if (this.isCentered) {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/international/?ref=global-home" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/opinionPagesHpC177.png" border="0" /></a></h4>';
      } else {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/international/?ref=global-home" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/opinionPagesHpL177.png" border="0" /></a></h4>';
      }
    } else {
      return "";
    }
